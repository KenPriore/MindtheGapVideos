...
const T = {
  title:     [0,    5],
  premise:   [5,    5],
  radar:     [10,   7],    // NEW — hero Anthropic visual
  seven:     [17,   5],
  chart:     [22,   6],
  notone:    [28,   5],
  roles:     [33,   7],
  spotlight: [40,   30],   // 5 × 6s
  modes:     [70,   7],
  process:   [77,   6],
  fluency:   [83,   6],
  pipeline:  [89,   6],
    ...
    <div style={{ position: 'absolute', inset: 0, background: C.paper, color: C.black, fontFamily: FONT }}>
      ...
      <div style={{ position: 'absolute', left: 620, right: 120, top: 120, bottom: 100,
        ...
        <div style={{ position: 'relative', width: '100%', height: '100%',
          ...
          <img src={window.__resources ? window.__resources.radar : "assets/anthropic-radar.png"} alt="Anthropic occupational radar chart"
            style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'contain' }} />
          {/* Legal callout ring — positioned on Legal spoke at right-center of chart */}
          <div style={{ position: 'absolute', left: '74%', top: '56%', width: 140, height: 140,
            border: `3px solid ${C.red}`, borderRadius: '50%',
            transform: `translate(-50%, -50%) scale(${0.5 + ring * 0.5})`,
          ...
          <div style={{ position: 'absolute', left: '74%', top: '40%',
            ...
            opacity: arrow, transform: `translate(-50%, 0) translateY(${(1-arrow) * -20}px)`,
      ...
      <div style={{ position: 'absolute', left: 120, top: 160, right: 120, bottom: 140, display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 80 }}>
        ...
        <div style={{ border: `1px solid ${C.black}`, background: C.white, padding: 20, display: 'flex', flexDirection: 'column',
          ...
          <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', position: 'relative' }}>
            <img src={window.__resources ? window.__resources.radar : "assets/anthropic-radar.png"} alt=""
...
const FluencyScene = () => {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, background: C.black, color: C.white, fontFamily: FONT }}>
      <Chrome label="10 · Fig 05 — The fluency gap" color={C.white} />
      <div style={{ position: 'absolute', left: 120, top: 150, right: 120 }}>
...
const TakeawayScene = () => {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, background: C.ink, color: C.white, fontFamily: FONT }}>
      <Chrome label="12 · The pattern" color={C.white} />
...
const Video = () => {
  ...
  return (
    <>
      ...
      <Sprite start={T.chart[0]}    end={T.chart[0] + T.chart[1]}><ChartScene /></Sprite>
      <Sprite start={T.notone[0]}   end={T.notone[0] + T.notone[1]}><NotOneJobScene /></Sprite>
...
Object.assign(window, {
  Video, TOTAL,
  // Individual scenes for teaser/remix
  TitleScene, PremiseScene, RadarScene, SevenScene, ChartScene,
  NotOneJobScene, RolesGridScene, RoleSpotlight,
  ModesScene, ProcessScene, FluencyScene, PipelineScene,
  TakeawayScene, CTAScene,
  ROLES, SPOT_NOTES,
});
